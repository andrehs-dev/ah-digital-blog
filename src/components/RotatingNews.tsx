...
export default function RotatingNews({ posts }: { posts: PostMeta[] }) {
  ...
  return (
    <section className="h-full">
      <div className="relative flex h-full flex-col overflow-hidden rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-card)] transition-all duration-500">
        ...
        {hasImage && (
          <div className="absolute inset-0">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[var(--theme-card)] via-[var(--theme-card)]/85 to-[var(--theme-card)]/60" />
          </div>
        )}
        ...
        <div className="relative z-10 flex h-full flex-col p-6 md:p-8">
          {/* Label */}
          <span className="mb-3 inline-block w-fit rounded-full bg-[var(--theme-primary)]/15 px-3 py-1 text-xs font-medium text-[var(--theme-primary)] backdrop-blur-sm">
