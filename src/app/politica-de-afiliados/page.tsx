...
export default function PoliticaAfiliados() {
  return (
    <article className="mx-auto max-w-2xl px-4 py-16 leading-relaxed text-white/80">
      <span className="text-xs uppercase tracking-[0.18em] text-blue-400 font-semibold">
        Transparência
      </span>
      ...
      <h2 className="mt-10 text-xl font-bold text-white">O que são links de afiliado?</h2>
      <p className="mt-3">
      ...
      <h2 className="mt-10 text-xl font-bold text-white">Isso afeta minhas escolhas?</h2>
      <p className="mt-3">
      ...
      <h2 className="mt-10 text-xl font-bold text-white">Quais programas usamos?</h2>
      <p className="mt-3">
      ...
      <h2 className="mt-10 text-xl font-bold text-white">Como identificar um link de afiliado?</h2>
      <p className="mt-3">
      ...
      <h2 className="mt-10 text-xl font-bold text-white">Isso é obrigatório?</h2>
      <p className="mt-3">
      ...
      <h2 className="mt-10 text-xl font-bold text-white">Dúvidas?</h2>
      <p className="mt-3">
