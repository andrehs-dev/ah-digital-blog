---
title: "Claude unifica memória do chat com o Cowork: chega de se reexplicar"
description: "Claude unificou a memória entre o chat e o Cowork: a IA agora lembra do que você conversou e aplica em tarefas automáticas. Veja o que muda e como controlar."
date: "2026-08-26"
tags: [anthropic, claude, ia, memoria, agentes-ia, produtividade]
image: "/images/claude-memoria-unificada-cowork-chat.jpg"
faq:
  - q: "O que mudou na memória do Claude?"
    a: "A Anthropic unificou o sistema de memória do chat convencional com o do Claude Cowork. Agora o contexto aprendido em uma conversa é compartilhado com as tarefas automatizadas, e a memória é atualizada durante a conversa, não apenas ao final dela."
  - q: "A memória unificada funciona em quais planos?"
    a: "Está disponível para os planos Free, Pro e Max, ativada por padrão nos planos individuais. Nos planos Team e Enterprise, os administradores controlam a liberação do recurso, e cada usuário precisa habilitar a memória individualmente nas configurações."
  - q: "O Claude guarda dados sensíveis na memória?"
    a: "Por padrão, não. Informações como dados de saúde, crenças religiosas, posicionamento político, raça, etnia e identidade de gênero não são armazenadas automaticamente. O usuário pode optar por incluí-las, mas alguns dados nunca são salvos, como números de documentos, histórico criminal e status de imigração."
  - q: "Como ver e apagar o que o Claude lembra?"
    a: "Em Configurações, depois em Memória, as informações ficam organizadas em uma lista de arquivos curtos por tópico. É possível visualizar, editar ou excluir cada item, pausar temporariamente a memória ou redefinir todo o histórico acumulado a qualquer momento."
  - q: "A memória do Claude é usada para anúncios?"
    a: "Não. A Anthropic afirma que o Claude continua sem anúncios e que nada do que fica na memória é usado para segmentação publicitária. A observação foi feita em tom de comparação com concorrentes durante o anúncio do recurso."
---
